...
-- Optional demo seed: run seed-oracle-sample-data.sql after this script.
-- =============================================================================
...
CREATE TABLE fast_problem (
    ...
    status                      VARCHAR2(30) DEFAULT 'BACKLOG',
...
-- FAST_PROBLEM_USER_GROUP (ticket impacts one-to-many user groups)
